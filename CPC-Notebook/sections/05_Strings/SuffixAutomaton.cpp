...
When to use: Use when the problem says all substrings, distinct substrings, longest common substring, or many occurrence queries.
Indexing: 0-indexed unless noted
Complexity: See code and notes.
Common bugs: Clone state must copy transitions.
*/
