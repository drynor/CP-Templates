...
When to use: Use for prefix sums with point updates, range sums, and range-update BIT variants.
Indexing: 0-indexed unless noted
Complexity: See code and notes.
Common bugs: This template is 0-indexed externally but internally shifts by +1.
*/
