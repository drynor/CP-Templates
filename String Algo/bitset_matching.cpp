// bitset_matching(),Constructor,O(N)
// set_text(),Initial text loading,O(M)
// update(),Single character update,O(1)
// pattern_count(),Find number of matches,O(M⋅N/w)
// pattern_pos(),Find match positions,O((M+k)⋅N/w)
template <int N>
