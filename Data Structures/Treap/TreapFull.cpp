...
// Function to generate a random priority, essential for Treap structure
int rnd() {
    static mt19937 rng(chrono::steady_clock::now().time_since_epoch().count());
    // Using a consistent seed for a standard distribution (e.g., [0, INT_MAX])
    return rng();
}
...
// The example usage block is left commented out but formatted
/*
int main() {
    // int i, j, k, n, m, l, r, q;
